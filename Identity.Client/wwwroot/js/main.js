var config = {
    ...
    redirect_uri: "https://localhost:7085/home/signin",
    post_logout_redirect_uri: "https://localhost:7085",
    response_type: "code",
    scope: "openid profile offline_access TestRemoteApi"
};
...
var callApi = function () {
    axios.get("https://localhost:7271/UserMenu/12")
        .then(res => {
            console.log(res);
        });
};
